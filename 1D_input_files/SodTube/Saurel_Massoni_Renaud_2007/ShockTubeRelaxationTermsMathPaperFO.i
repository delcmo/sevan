...
[UserObjects]
  ...
  [./JumpGradAlphaSmoothLiq]
    type = SmoothFunction
    variable = jump_grad_alpha_aux_l
    var_name = jump_grad_alpha_smooth_aux_l
    execute_on = timestep_begin
  [../]
[]
...
[Materials]
  [./ViscCoeffLiq]
    ...
    jump_grad_alpha = jump_grad_alpha_smooth_aux_l # jump_grad_alpha_aux
    vf_liquid = alpha_aux_l
    eos = eos_liq
...
[Postprocessors]
  ...
  [./dt]
    type = TimeStepCFL
    volume-fraction-liquid = alA_l
    alpha-A-rho-liq = alrhoA_l
    alpha-A-rhou-liq = alrhouA_l
    alpha-A-rhoE-liq = alrhoEA_l
    alpha-A-rho-gas = alrhoA_g
    alpha-A-rhou-gas = alrhouA_g
    alpha-A-rhoE-gas = alrhoEA_g
    eos-liq = eos_liq
    eos-gas = eos_gas
  [../]
[]
...
[Executioner]
  ...
  [./TimeStepper]
    ...
    dt  =1.e-5
#    type = FunctionDT
#    time_t =  '0      1.e-6  5.e-6'
#    time_dt = '5.e-7  5.e-7  5.e-7'
  [../]
  [./Quadrature]
    type = GAUSS
    order = SECOND
